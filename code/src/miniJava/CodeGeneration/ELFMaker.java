...
public class ELFMaker {
	...
	private ArrayList<ELFSection> sections = new ArrayList<>();
	private ArrayList<ELFSegment> segments = new ArrayList<>();
	...
	public void outputELF(String fname, byte[] textSection, long entrypoint) {
		...
		try {
			...
			errors.reportError("FileNotFoundException: " + e);
		} catch (IOException e) {
			errors.reportError("IOException: " + e);
		}
	}
